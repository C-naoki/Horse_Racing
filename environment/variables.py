...
# venue_id_list = ["2022050103", '2022100107', '2022070111']
venue_id_list = ["2022050103"]
# レース日
date = '2022/02/05'
# 日付の分割
year = date[0:4]
...
fukusho_columns = ["複勝的中率(◎)", "複勝的中率(○))", "複勝的中率(▲)"]
total_columns = ['単勝A', '三連単A', '三連複A', '単勝B', '三連単B', '三連複B', '単勝C', '三連単C', '三連複C', '単勝ABC', '三連単ABC', '三連複ABC', '単勝', '三連単', '三連複', '複勝(◎)', '複勝(○)', '複勝(▲)']
